...
from src.internal.hooks import HookExecutionError
from src.internal.hooks import HookFailStrategy
from src.internal.hooks import HookPoint
from src.internal.hooks import HookRegistry
from src.internal.hooks import HookSkipped
...
def test_execute_hook_posts_payload_and_validates_response(monkeypatch):
    ...
    monkeypatch.setattr(
        "src.internal.hooks.executor.urllib.request.urlopen", fake_urlopen
    )
    registry = HookRegistry(
        [
            HookConfig(
