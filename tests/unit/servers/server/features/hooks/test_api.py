...
from src.servers.features.hooks.api import HookValidateResponse
from src.servers.features.hooks.api import HookValidateStatus
from src.servers.features.hooks.api import _check_ssrf_safety
from src.servers.features.hooks.api import _raise_for_validation
from src.servers.features.hooks.api import _validate_endpoint
...
class TestValidateEndpoint:
    def _call(self, *, api_key: str | None = _API_KEY) -> HookValidateResponse:
        with patch("src.servers.features.hooks.api._check_ssrf_safety"):
    ...
    @patch("src.servers.features.hooks.api.httpx.Client")
