...
class TestMakeBillingRequest:
    ...
    async def test_makes_post_request_and_returns_json(self) -> None:
        from src.internal.servers.billing.service import _make_billing_request
...
class TestCreateCheckoutSession:
    ...
    async def test_builds_body_and_returns_url(self) -> None:
        from src.internal.servers.billing.service import create_checkout_session

        with patch(
            "src.internal.servers.billing.service._make_billing_request",
...
class TestCreateCustomerPortalSession:
    ...
    async def test_returns_portal_url(self) -> None:
        from src.internal.servers.billing.service import create_customer_portal_session
...
class TestGetBillingInformation:
    ...
    async def test_returns_billing_info_when_subscribed(self) -> None:
        ...
        from src.internal.servers.billing.service import get_billing_information
...
class TestUpdateSeatCount:
    ...
    async def test_updates_seats_and_returns_response(self) -> None:
        from src.internal.servers.billing.service import update_seat_count
...
class TestEndTrial:
    ...
    async def test_raises_501_for_self_hosted(self) -> None:
        ...
        from src.internal.servers.billing.service import end_trial
