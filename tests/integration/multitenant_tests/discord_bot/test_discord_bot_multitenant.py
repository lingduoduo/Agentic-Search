...
class TestBotConfigIsolationCloudMode:
    ...
    def test_cannot_create_bot_config_in_cloud_mode(self) -> None:
        ...
        with patch("src.internal.configs.app_configs.AUTH_TYPE", AuthType.CLOUD):
    ...
    def test_bot_token_from_env_only_in_cloud(self) -> None:
        ...
        with (
            patch("src.internal.configs.app_configs.DISCORD_BOT_TOKEN", "env_token"),
            patch("src.internal.configs.app_configs.AUTH_TYPE", AuthType.CLOUD),
        ):
