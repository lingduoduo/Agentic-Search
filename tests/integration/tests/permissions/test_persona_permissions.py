...
def test_persona_permissions(reset: None) -> None:  # noqa: ARG001
    ...
    basic_user_persona = PersonaManager.create(
        ...
        is_public=False,
        groups=[],
        users=[admin_user.id],  # noqa: F821,F841
        user_performing_action=basic_user,  # noqa: F821,F841
    )
    PersonaManager.verify(basic_user_persona, user_performing_action=basic_user)  # noqa: F821,F841
    ...
    PersonaManager.verify(curator_persona, user_performing_action=curator)  # noqa: F821,F841
    ...
    PersonaManager.verify(admin_persona_group_1, user_performing_action=curator)  # noqa: F821,F841
    ...
    PersonaManager.edit(
        ...
        users=[admin_user.id, admin_user.id],  # noqa: F821,F841
        user_performing_action=admin_user,  # noqa: F821,F841
    )
    PersonaManager.verify(basic_user_persona, user_performing_action=admin_user)  # noqa: F821,F841
    ...
    PersonaManager.verify(curator_persona, user_performing_action=admin_user)  # noqa: F821,F841
    ...
    PersonaManager.verify(admin_persona_group_1, user_performing_action=admin_user)  # noqa: F821,F841
    ...
    PersonaManager.verify(admin_persona_group_2, user_performing_action=admin_user)  # noqa: F821,F841
    ...
    PersonaManager.verify(admin_persona_both_groups, user_performing_action=admin_user)  # noqa: F821,F841
