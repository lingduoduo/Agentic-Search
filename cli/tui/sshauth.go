...
func (m AuthModel) View() string {
	...
	b.WriteString("\n")
	b.WriteString("  \x1b[1;35mAgentic Search CLI\x1b[0m\n")
	...
	b.WriteString("  \x1b[90m  export AGENTIC_SEARCH_PAT=<key>\x1b[0m\n")
	b.WriteString("  \x1b[90m  ssh -o SendEnv=AGENTIC_SEARCH_PAT <host> -p <port>\x1b[0m\n")
	b.WriteString("\n")
...
func NewServeModel(serverCfg config.Config, initialErr string, validateFunc func(string, string) error) ServeModel {
	return ServeModel{
