// Package tui implements the Bubble Tea TUI for Agentic Search CLI.
package tui
...
func NewModel(cfg config.Config, client api.ClientAPI) Model {
	parentID := -1
...
func NewFirstRunModel(cfg config.Config) Model {
