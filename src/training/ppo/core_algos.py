"""Core PPO / GRPO tensor algorithms.

This module intentionally contains no rollout-manager or search-agent state.
It is the small numerical layer shared by training code.
"""
