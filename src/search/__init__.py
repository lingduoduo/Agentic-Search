...
_LAZY_EXPORTS: dict[str, str] = {
    "OnlineSearchConfig": "src.servers.retrieval_servers.google",
    "OnlineSearchEngine": "src.servers.retrieval_servers.google",
    "SerpSearchConfig": "src.servers.retrieval_servers.serp",
    "SerpSearchEngine": "src.servers.retrieval_servers.serp",
    ...
    "RetrievalServerConfig": "src.servers.retrieval_servers.retrieval",
    "RerankerConfig": ".rerank",
    "RetrievalRerankConfig": "src.servers.retrieval_servers.retrieval_rerank",
    "create_base_app": "src.servers.retrieval_servers.app",
