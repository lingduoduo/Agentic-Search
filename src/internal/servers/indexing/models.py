...
from src.internal.document_index.models import SwitchoverType
...
if TYPE_CHECKING:
    from src.internal.servers.indexing.embedder import DocumentBatchPrepareContext
...
class DocAwareChunk(BaseChunk):
    ...
    # in the chunk. doc_summary and chunk_context combined should
...
class EmbeddingModelDetail(BaseModel):
    ...
    @classmethod
    def from_db_model(cls, search_settings: Any) -> "EmbeddingModelDetail":
...
class IndexingSetting(EmbeddingModelDetail):
    ...
    @classmethod
    def from_db_model(cls, search_settings: Any) -> "IndexingSetting":
        raise NotImplementedError("requires DB")
