...
from src.internal.servers.indexing.models import ChunkEmbedding
from src.internal.servers.indexing.models import DocAwareChunk
from src.internal.servers.indexing.models import IndexChunk
from src.internal.natural_language_processing.search_nlp_models import EmbeddingModel
from src.internal.utils.pydantic_util import shallow_model_dump
...
class DefaultIndexingEmbedder(IndexingEmbedder):
    ...
    def from_db_search_settings(
        ...
        raise NotImplementedError("requires DB")
