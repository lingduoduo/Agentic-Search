...
def refresh_hierarchy_cache_from_db(
    ...
    raise NotImplementedError(
        "refresh_hierarchy_cache_from_db requires a DB session — not yet wired to src.internal.db"
    )
...
def _walk_ancestor_chain(
    ...
    raise NotImplementedError(
        "_walk_ancestor_chain requires a DB session — not yet wired to src.internal.db"
    )
...
def get_ancestors_from_raw_id(
    ...
    raise NotImplementedError(
        "get_ancestors_from_raw_id requires a DB session — not yet wired to src.internal.db"
    )
...
def get_source_node_id_from_cache(
    ...
    raise NotImplementedError(
        "get_source_node_id_from_cache requires a DB session — not yet wired to src.internal.db"
    )
...
def ensure_source_node_exists(
    ...
    raise NotImplementedError(
        "ensure_source_node_exists requires a DB session — not yet wired to src.internal.db"
    )
