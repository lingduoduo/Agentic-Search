...
from src.internal.document_index.models import IndexFilters
from src.internal.document_index.interfaces import TenantState
from src.internal.document_index.opensearch.constants import ASSUMED_DOCUMENT_AGE_DAYS
from src.internal.document_index.opensearch.constants import (
...
from src.internal.document_index.opensearch.schema import ACCESS_CONTROL_LIST_FIELD_NAME
from src.internal.document_index.opensearch.schema import (
    ANCESTOR_HIERARCHY_NODE_IDS_FIELD_NAME,
)
from src.internal.document_index.opensearch.schema import CHUNK_INDEX_FIELD_NAME
from src.internal.document_index.opensearch.schema import CONTENT_FIELD_NAME
from src.internal.document_index.opensearch.schema import CONTENT_VECTOR_FIELD_NAME
from src.internal.document_index.opensearch.schema import DOCUMENT_ID_FIELD_NAME
from src.internal.document_index.opensearch.schema import DOCUMENT_SETS_FIELD_NAME
from src.internal.document_index.opensearch.schema import HIDDEN_FIELD_NAME
from src.internal.document_index.opensearch.schema import LAST_UPDATED_FIELD_NAME
from src.internal.document_index.opensearch.schema import MAX_CHUNK_SIZE_FIELD_NAME
from src.internal.document_index.opensearch.schema import METADATA_LIST_FIELD_NAME
from src.internal.document_index.opensearch.schema import PERSONAS_FIELD_NAME
from src.internal.document_index.opensearch.schema import PUBLIC_FIELD_NAME
from src.internal.document_index.opensearch.schema import set_or_convert_timezone_to_utc
from src.internal.document_index.opensearch.schema import SOURCE_TYPE_FIELD_NAME
from src.internal.document_index.opensearch.schema import TENANT_ID_FIELD_NAME
from src.internal.document_index.opensearch.schema import TITLE_FIELD_NAME
from src.internal.document_index.opensearch.schema import TITLE_VECTOR_FIELD_NAME
from src.internal.document_index.opensearch.schema import USER_PROJECTS_FIELD_NAME

# Read from environment
DEFAULT_OPENSEARCH_QUERY_TIMEOUT_S: int = int(
    os.environ.get("DEFAULT_OPENSEARCH_QUERY_TIMEOUT_S", "30")
)
OPENSEARCH_EXPLAIN_ENABLED: bool = os.environ.get(
    "OPENSEARCH_EXPLAIN_ENABLED", ""
).lower() in {"1", "true", "yes"}
OPENSEARCH_MATCH_HIGHLIGHTS_DISABLED: bool = os.environ.get(
    "OPENSEARCH_MATCH_HIGHLIGHTS_DISABLED", ""
).lower() in {"1", "true", "yes"}
OPENSEARCH_PROFILING_DISABLED: bool = os.environ.get(
    "OPENSEARCH_PROFILING_DISABLED", "1"
).lower() in {"1", "true", "yes"}
