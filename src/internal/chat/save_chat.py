...
from src.internal.chat.chat_state import SearchDocKey
...
from src.internal.chat.llm_step import sanitize_string  # noqa: E402
...
def add_search_docs_to_chat_message(
    *, chat_message_id: int, search_doc_ids: list[int], db_session: _Any
    ...
    from src.internal.db.models import ChatMessage as _ChatMessage
