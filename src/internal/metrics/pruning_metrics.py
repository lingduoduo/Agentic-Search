...
Usage:
    from src.internal.metrics.pruning_metrics import (
...
PRUNING_ENUMERATION_DURATION = Histogram(
    "agentic_search_pruning_enumeration_duration_seconds",
...
PRUNING_DIFF_DURATION = Histogram(
    "agentic_search_pruning_diff_duration_seconds",
...
PRUNING_RATE_LIMIT_ERRORS = Counter(
    "agentic_search_pruning_rate_limit_errors_total",
