...
Usage:
    from src.internal.metrics.deletion_metrics import (
...
DELETION_BLOCKED = Counter(
    "agentic_search_deletion_blocked_total",
    "Times deletion was blocked by a dependency",
    ["tenant_id", "blocker"],
)

DELETION_FENCE_RESET = Counter(
    "agentic_search_deletion_fence_reset_total",
