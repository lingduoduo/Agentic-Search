...
Usage in a worker app module:
    from src.internal.metrics.indexing_task_metrics import (
...
from src.internal.metrics.celery_task_metrics import _MAX_START_TIME_AGE_SECONDS


class _CeleryTasks:
    CONNECTOR_DOC_FETCHING_TASK = "connector_doc_fetching_proxy_task"
...
INDEXING_TASK_DURATION = Histogram(
    "agentic_search_indexing_task_duration_seconds",
