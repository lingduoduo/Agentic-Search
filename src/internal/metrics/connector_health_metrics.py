...
correct value across instances, e.g.:
    max by (cc_pair_id, connector_name) (agentic_search_connector_in_error_state)
...
INDEX_ATTEMPT_STATUS = Counter(
    "agentic_search_index_attempt_transitions_total",
