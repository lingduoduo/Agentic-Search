...
Usage in a worker app module:
    from src.internal.metrics.celery_task_metrics import (
...
TASK_STARTED = Counter(
    "agentic_search_celery_task_started_total",
    "Total Celery tasks started",
    ["task_name", "queue"],
)

TASK_COMPLETED = Counter(
    "agentic_search_celery_task_completed_total",
    "Total Celery tasks completed",
    ["task_name", "queue", "outcome"],
)

TASK_DURATION = Histogram(
    "agentic_search_celery_task_duration_seconds",
