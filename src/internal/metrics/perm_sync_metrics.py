...
Usage:
    from src.internal.metrics.perm_sync_metrics import (
...
DOC_PERM_SYNC_DURATION = Histogram(
    "agentic_search_doc_perm_sync_duration_seconds",
...
DOC_PERM_SYNC_DB_UPDATE_DURATION = Histogram(
    "agentic_search_doc_perm_sync_db_update_duration_seconds",
...
DOC_PERM_SYNC_DOCS_PROCESSED = Counter(
    "agentic_search_doc_perm_sync_docs_processed_total",
    "Total documents successfully synced during doc permission sync",
    ["connector_type"],
)

DOC_PERM_SYNC_ERRORS = Counter(
    "agentic_search_doc_perm_sync_errors_total",
...
GROUP_SYNC_DURATION = Histogram(
    "agentic_search_group_sync_duration_seconds",
...
GROUP_SYNC_UPSERT_DURATION = Histogram(
    "agentic_search_group_sync_upsert_duration_seconds",
