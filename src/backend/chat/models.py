...
from src.backend.servers.query_and_chat.streaming_models import GeneratedImage
...
from src.backend.tools.models import ToolResultType
...
class ChatLoadedFile(InMemoryChatFile):
    ...
    def lazy_loaded(
        ...
        *,
        ...
        """
        from src.backend.file_store.models import install_lazy_content_loader
