...
from src.backend.cache.interface import CacheBackendType
...
def _build_redis_backend(tenant_id: str) -> CacheBackend:
    ...
    from src.backend.cache.redis_backend import RedisCacheBackend
...
def _build_postgres_backend(tenant_id: str) -> CacheBackend:
    from src.backend.cache.postgres_backend import PostgresCacheBackend
