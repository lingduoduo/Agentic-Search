...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_ENTITY_TERM_EXTRACTION = 15
...
AGENT_DEFAULT_TIMEOUT_LLM_ENTITY_TERM_EXTRACTION = 45
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_DOCUMENT_VERIFICATION = 5
...
AGENT_DEFAULT_TIMEOUT_LLM_DOCUMENT_VERIFICATION = 8
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_GENERAL_GENERATION = 8
...
AGENT_DEFAULT_TIMEOUT_LLM_GENERAL_GENERATION = 45
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_SUBQUESTION_GENERATION = 8
...
AGENT_DEFAULT_TIMEOUT_LLM_SUBQUESTION_GENERATION = 10
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_SUBANSWER_GENERATION = 9
...
AGENT_DEFAULT_TIMEOUT_LLM_SUBANSWER_GENERATION = 45
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_INITIAL_ANSWER_GENERATION = 15
...
AGENT_DEFAULT_TIMEOUT_LLM_INITIAL_ANSWER_GENERATION = 40
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_REFINED_ANSWER_GENERATION = 20
...
AGENT_DEFAULT_TIMEOUT_LLM_REFINED_ANSWER_GENERATION = 60
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_SUBANSWER_CHECK = 6
...
AGENT_DEFAULT_TIMEOUT_LLM_SUBANSWER_CHECK = 12
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_REFINED_SUBQUESTION_GENERATION = 6
...
AGENT_DEFAULT_TIMEOUT_LLM_REFINED_SUBQUESTION_GENERATION = 12
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_QUERY_REWRITING_GENERATION = 4
...
AGENT_DEFAULT_TIMEOUT_LLM_QUERY_REWRITING_GENERATION = 6
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_HISTORY_SUMMARY_GENERATION = 6
...
AGENT_DEFAULT_TIMEOUT_LLM_HISTORY_SUMMARY_GENERATION = 8
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_COMPARE_ANSWERS = 6
...
AGENT_DEFAULT_TIMEOUT_LLM_COMPARE_ANSWERS = 12
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_REFINED_ANSWER_VALIDATION = 6
...
AGENT_DEFAULT_TIMEOUT_LLM_REFINED_ANSWER_VALIDATION = 12
