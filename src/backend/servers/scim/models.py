...
Admin API schemas for SCIM token management.
"""
...
class ScimUserResource(BaseModel):
    ...
    id: str | None = None  # internal user ID, set on responses
...
class ScimGroupMember(BaseModel):
    ...
    or removing users from groups. ``value`` is the user ID.
    """
...
# ---------------------------------------------------------------------------
# Admin API Schemas (internal, for SCIM token management)
