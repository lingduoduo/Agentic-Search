...
from src.backend.prompts.search_prompts import DOCUMENT_CONTEXT_SELECTION_PROMPT
from src.backend.prompts.search_prompts import DOCUMENT_SELECTION_PROMPT
from src.backend.prompts.search_prompts import MAX_CHUNKS_FOR_RELEVANCE
from src.backend.prompts.search_prompts import TRY_TO_FILL_TO_MAX_INSTRUCTIONS
