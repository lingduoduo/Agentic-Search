...
from src.backend.servers.evals.models import ChatFullEvalResult
...
from src.backend.servers.evals.models import EvalTimings
from src.backend.servers.evals.models import EvalToolResult
from src.backend.servers.evals.models import MultiTurnEvalResult
from src.backend.servers.evals.models import ToolAssertion
...
def _get_answer_with_tools(
    ...
    raise NotImplementedError(
        "_get_answer_with_tools requires onyx.db — wire to src.backend.db before use"
    )
...
def _get_multi_turn_answer_with_tools(
    ...
    """
    raise NotImplementedError(
        "_get_multi_turn_answer_with_tools requires onyx.db — wire to src.backend.db before use"
    )
