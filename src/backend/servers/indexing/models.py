...
from src.backend.document_index.models import SwitchoverType
from src.backend.connectors.models import Document
from src.backend.utils.pydantic_util import shallow_model_dump
from src.shared_configs.enums import EmbeddingProvider
from src.shared_configs.model_server_models import Embedding

if TYPE_CHECKING:
    from src.backend.servers.indexing.embedder import DocumentBatchPrepareContext
