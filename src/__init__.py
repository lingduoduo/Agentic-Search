...
_LAZY_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "ActorRolloutStep": (".training.grpo.generation", "ActorRolloutStep"),
    "ContinuationDecision": (".training.grpo.generation", "ContinuationDecision"),
    "FinalGenBatchOutput": (".training.grpo.generation", "FinalGenBatchOutput"),
    "GenerationConfig": (".training.grpo.generation", "GenerationConfig"),
    "GRPOPromptGroupResult": (".training.grpo.generation", "GRPOPromptGroupResult"),
    "GRPORolloutSafetyConfig": (".training.grpo.generation", "GRPORolloutSafetyConfig"),
    "GRPOTrainingStepResult": (".training.grpo.generation", "GRPOTrainingStepResult"),
    "GroupedRolloutBatch": (".training.grpo.generation", "GroupedRolloutBatch"),
    "LLMGenerationManager": (".training.grpo.generation", "LLMGenerationManager"),
    "PPOPolicyLossConfig": (".training.grpo.generation", "PPOPolicyLossConfig"),
    "ReActContextTransition": (".training.grpo.generation", "ReActContextTransition"),
    "ScoredGroupedRollout": (".training.grpo.generation", "ScoredGroupedRollout"),
    "SearchBatch": (".training.grpo.generation", "SearchBatch"),
    "SearchDecision": (".training.grpo.generation", "SearchDecision"),
    "SearchStep": (".training.grpo.generation", "SearchStep"),
    "SearchTrajectoryLog": (".training.grpo.generation", "SearchTrajectoryLog"),
    "apply_rollout_safety_penalties": (
        ".training.grpo.generation",
        "apply_rollout_safety_penalties",
    ),
    ...
    "format_group_rollout": (".training.grpo.generation", "format_group_rollout"),
    ...
    "format_trajectory_batch": (".training.grpo.generation", "format_trajectory_batch"),
    "save_training_batch_jsonl": (
        ".training.grpo.generation",
        "save_training_batch_jsonl",
    ),
    "score_group_rollout": (".training.grpo.generation", "score_group_rollout"),
    ...
    "TensorConfig": (".training.grpo.tensor_helper", "TensorConfig"),
    "TensorHelper": (".training.grpo.tensor_helper", "TensorHelper"),
}
