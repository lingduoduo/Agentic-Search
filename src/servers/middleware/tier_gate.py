...
from src.configs.license_enforcement_config import PATH_PREFIX_MIN_TIER
from src.configs.license_enforcement_config import is_license_enforcement_exempt
...
def add_tier_gate_middleware(
    ...
    async def enforce_tier_gate(
        ...
        try:
            from src.servers.license.api import _load_license_data
